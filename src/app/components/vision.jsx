...
export default function VisionMission() {
  ...
  return (
    <div className="w-full px-4 py-10 md:py-18 md:px-10 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {cards.map((card, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
           className="bg-gradient-to-r from-orange-400 to-yellow-300 shadow-lg transform hover:scale-105 rounded-2xl p-6  hover:shadow-2xl transition"
            ...
            <ul className="space-y-3">
              {card.items.map((item, idx) => (
                <li key={idx} className="flex items-start gap-3">
                  <CheckCircle size={16} className="text-black mt-1 min-w-[22px]" />
