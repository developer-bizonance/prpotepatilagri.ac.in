      ...
      try {
        ...
        const allImages = data
          ...
          .filter((img) => {
            ...
            return (
              img.category.toLowerCase() === currentTab.toLowerCase() ||
              img.sub_category.toLowerCase() === currentTab.toLowerCase()
            );
          });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-2xl md:text-3xl font-extrabold text-[#1e293b] border-l-[4px] border-orange-500 pl-3 capitalize">
            Explore Our <span className="text-orange-500">{currentTab ? currentTab : "Facilities"}</span>
          </h1>
        </div>
          ...
          <div className="space-y-12">
            {Object.entries(groupedImages).map(([subCategoryName, images]) => (
              <div key={subCategoryName} className="flex flex-col">
                ...
                {/* Sub-Category Title with Orange Border */}
