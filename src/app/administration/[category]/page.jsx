...
export default function AdministrationCategoryPage() {
  ...
  // Aapke Navigation Navbar ke hisab se titles
  const categoryTitles = {
    "grievance-redressal": { title: "Grievance Redressal Cell", desc: "View documents, reports, and notices regarding grievance redressal." },
    "academy-advisory": { title: "Academy Advisory Body", desc: "Explore the structure and resolutions of the advisory body." },
    "anti-ragging": { title: "Anti-Ragging Squad", desc: "Important guidelines, committee members, and anti-ragging policies." },
    "staff-council": { title: "Staff Council Constitution", desc: "Read the constitution and meeting minutes of the staff council." },
    "useful-links": { title: "Useful Links", desc: "Important external resources and quick links for students and staff." },
  };

  const pageInfo = categoryTitles[category] || { 
    title: "Administration Document", 
    desc: "View related documents and links." 
  };
  ...
  const fetchDocuments = async () => {
    try {
      setIsLoading(true);
      const res = await fetch("http://localhost:4001/api/administration");
